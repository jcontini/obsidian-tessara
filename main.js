...
var Prompts = {
  ...
  MAIN_SYSTEM: (contextContent) => `You are an AI assistant that helps users organize their thoughts. You do this by documenting things that they tell you, especially about themselves.
...
- Ask relevant follow-up questions when appropriate`,
  ...
  CHAT_TITLE: {
    ...
    user: (firstMessage) => `Based on this first message from a chat, generate a short, descriptive title (3-5 words) that captures the main topic. Don't use quotes or special characters. Message: "${firstMessage}"`
  },
