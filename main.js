...
var TesseraPlugin = class extends import_obsidian3.Plugin {
  async onload() {
  ...
  initializeClaudeClient(apiKey) {
    try {
      ...
      new import_obsidian3.Notice("Failed to initialize Claude client");
    }
  }
  async activateView() {
    ...
    if (!leaf) {
      ...
      if (!newLeaf) {
        new import_obsidian3.Notice("Failed to create view");
        return;
      }
      leaf = newLeaf;
