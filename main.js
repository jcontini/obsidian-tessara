...
var TesseraSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("Project Debug Path").setDesc("Path to save debug logs in your project directory (e.g., debug/debug.md)").addText((text) => text.setPlaceholder("/Users/joe/dev/obsidian-tessara/.context/debug.md").setValue(this.plugin.settings.projectDebugPath || "").onChange(async (value) => {
