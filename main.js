...
`;
  ...
  async copyConversation() {
    if (this.messages.length === 0) {
      new import_obsidian.Notice("No messages to copy");
      return;
    }
    const markdown = await this.generateConversationMarkdown();
    try {
      ...
      new import_obsidian.Notice("Failed to copy conversation");
    }
  }
};
