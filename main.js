...
Remember: Your goal is to build and maintain a helpful understanding of the user while providing thoughtful guidance.`;
    const userMessage = {
      role: "user",
      content: content === "START_CONVERSATION" ? "Please start the conversation with a succinct: 'What's on your mind?'." : content
    };
