...
var TesseraSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("Debug Mode").setDesc("Enable debug logging to debug.md in vault root").addToggle((toggle) => toggle.setValue(this.plugin.settings.debugMode).onChange(async (value) => {
      this.plugin.settings.debugMode = value;
      await this.plugin.saveSettings();
      this.app.workspace.getLeavesOfType("tessera-chat").forEach((leaf) => leaf.view.refresh());
    }));
  }
};
...
var TesseraPlugin = class extends import_obsidian5.Plugin {
  ...
  async sendMessage(content) {
    ...
    try {
      ...
      const messages = [...this.conversationHistory, newMessage];
